...
import DailyStatsModule from '@/components/admin/DailyStatsModule';
...
export default function AdminPage() {
  ...
  const tabs = [
    ...
    { id: 'daily-stats', label: 'Estadísticas Diarias', icon: '📈' },
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <main className="flex-1 lg:ml-0 overflow-auto">
        ...
        <div className="p-4 lg:p-8">
          ...
          {/* Otras pestañas */}
          {activeTab !== 'dashboard' && activeTab !== 'seasons' && activeTab !== 'weeks' && activeTab !== 'candidates' && activeTab !== 'nominees' && activeTab !== 'users' && activeTab !== 'cloudinary' && activeTab !== 'social-media' && activeTab !== 'dedication-reports' && activeTab !== 'daily-stats' && (
